...
function initDB() {
    ...
    const collections = ['users', 'categories', 'suppliers', 'trainings', 'agent_products', 'orders', 'vinted_stock', 'sales_platforms', 'shipping_batches', 'boutique_categories', 'boutique_products', 'boutique_orders', 'ai_orders'];
